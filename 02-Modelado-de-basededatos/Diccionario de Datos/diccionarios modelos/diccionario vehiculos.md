...
| Marca            | NVARCHAR      | 100    | ❌   | ❌   | ❌   | ❌     | Solo letras A-Z, longitud >= 3  | -                   | Marca del vehículo                |
| Anio              | INT          | -      | ❌   | ❌   | ❌   | ❌     | BETWEEN 1900 AND YEAR(GETDATE())| -                   | Año de fabricación del vehículo   |
| Modelo           | NVARCHAR      | 150    | ❌   | ❌   | ❌   | ❌     | Solo letras y números, longitud >= 2 | -            | Modelo del vehículo               |
| Placa            | NVARCHAR      | 10     | ❌   | ❌   | ❌   | ✅     | Formato válido de placas        | -                   | Placas del vehículo               |
...
| Nombre           | NVARCHAR      | 100    | ❌   | ❌   | ❌   | ❌     | Solo letras A-Z, longitud >= 3  | -                   | Nombre de la sucursal             |
| Ubicacion        | NVARCHAR      | 100    | ❌   | ❌   | ❌   | ❌     | Solo letras y números, longitud >= 5 | -              | Ubicación de la sucursal          |
